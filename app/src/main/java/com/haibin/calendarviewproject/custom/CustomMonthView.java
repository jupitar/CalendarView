...
//        }
        ...
        if (hasScheme) {
            canvas.drawCircle(x + mItemWidth - mCircleRadius / 2, y + mCircleRadius, mCircleRadius, mSchemeBasicPaint);
            mTextPaint.setColor(calendar.getSchemeColor());
            canvas.drawText(calendar.getScheme(), x + mItemWidth  - mCircleRadius, y  +mSchemeBaseLine, mTextPaint);
        }
